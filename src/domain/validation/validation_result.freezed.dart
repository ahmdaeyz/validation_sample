...
class _$ValidationResultTearOff {
  ...
  Invalid<U> invalid<U>({required U reason}) {
    return Invalid<U>(
      reason: reason,
    );
  }
...
mixin _$ValidationResult<U> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(U reason) invalid,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function()? valid,
    TResult Function(U reason)? invalid,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Invalid<U> implements Invalid<U> {
  _$Invalid({required this.reason});
  ...
  @override
  String toString() {
    return 'ValidationResult<$U>.invalid(reason: $reason)';
  }
...
abstract class Invalid<U> implements ValidationResult<U> {
  factory Invalid({required U reason}) = _$Invalid<U>;
